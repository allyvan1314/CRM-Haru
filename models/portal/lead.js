...
const leadSchema = new mongoose.Schema({
    loan_amount: {type: String,require: true,},
    loan_duration: {type: String,require: true,},
    cus_name: {type: String,required: true,},
    cus_phone: {type: String,required: true,},
    cus_gender: {type: String,required: true,},
    cus_id: {type: String,required: true,},
    cus_dob: {type: String,required: true,},
    cus_cur_city: {type: String},
    cus_cur_district: {type: String},
    cus_cur_ward: {type: String,required: true,},
